...
void Niveles::SetLvl2()
{
	...
	plataformas.Agregar(aux);
	aux = new Pared(426.5, -20.0, 0.0f, 45); //14
	plataformas.Agregar(aux);
	aux = new Pared(445, -5.2, 0.0f, 47);// 15
	plataformas.Agregar(aux);
	aux = new Pared(485, 11, 0.0f, 45.5);// 16
	plataformas.Agregar(aux);
	aux = new Pared(530.0, -15, 0.0f, 30);// 17
	plataformas.Agregar(aux);
}
...
void Niveles::SetLvl3()
{
	...
	plataformas.Agregar(aux);
	aux = new Pared(386, -10.0, 0.5f, 33.5);// 15
	plataformas.Agregar(aux);
	aux = new Pared(433.5, 11.5, 0.0f, 16);// 16
	plataformas.Agregar(aux);
	aux = new Pared(473.5, -20.0, 0.0f, 16);// 17
	plataformas.Agregar(aux);
...
void Niveles::DibujarLvl3()
{
	...
	glBegin(GL_POLYGON);
	glColor3f(1, 1, 1);
	glTexCoord2d(0, 0); glVertex3f(545, 38, -10);
	glTexCoord2d(1, 0); glVertex3f(1175, 38, -10);
	glTexCoord2d(1, 1); glVertex3f(1175, -43, -10);
	glTexCoord2d(0, 1); glVertex3f(545, -43, -10);
	glEnd();
	glEnable(GL_LIGHTING);
	glDisable(GL_TEXTURE_2D);
}
